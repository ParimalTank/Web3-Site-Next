...
function App() {
    ...
    const loggedInView = (
        <>
            ...
            <div id="console" style={{ whiteSpace: "pre-line", color: "white" }}>
    ...
    const unloggedInView = (
        <button onClick={login} className="cursor-pointer lg:flex justify-end text-xl font-semibold py-4 px-6 lg:px-12 navbutton text-white">
            Login
        </button>
    );
    ...
    return (
        <div className="container">
            <div className="flex justify-center mt-[50px] text-white">{loggedIn ? loggedInView : unloggedInView}</div>
        </div>
    );
}
